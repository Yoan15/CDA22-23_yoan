...
echo '</div><div class="grid-col-6 gridListe grid-contenu">';

foreach ($objets as $unProduit) {
	

// Affichage des enregistrements de la base de données
echo '<div class="donnees ">'.$unProduit->getNomProduit().'</div>';
echo '<div class="donnees ">'.$unProduit->getCouleurProduit().'</div>';
echo '<div class="donnees ">'.$unProduit->getPoidsProduit().'</div>';
 echo '<a href="index.php?page=FormProduits&mode=Afficher&id='.$unProduit->getIdProduit().'"><i class="fas fa-file-contract"></i></a>';
                                    
echo '<a href="index.php?page=FormProduits&mode=Modifier&id='.$unProduit->getIdProduit().'"><i class="fas fa-pen"></i></a>';
                                    
echo '<a href="index.php?page=FormProduits&mode=Supprimer&id='.$unProduit->getIdProduit().'"><i class="fas fa-trash-alt"></i></a>';
}
