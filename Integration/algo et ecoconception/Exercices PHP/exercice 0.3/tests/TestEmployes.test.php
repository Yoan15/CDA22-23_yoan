...
$e[] = new TestEmployes(["nom"=> "Dupond","prenom"=> "Claude","dateEmbauche"=> new DateTime("2015-05-18"),"poste"=> "Vendeur","salaire"=> 17,"service"=> "Commercial", "agence"=>$a1, "enfants"=>[$enfant[1]]]);
$e[] = new TestEmployes(["nom"=> "Riviera","prenom"=> "Antonio","dateEmbauche"=> new DateTime("2022-03-01"),"poste"=> "Responsable Réseaux","salaire"=> 35,"service"=> "Informatique", "agence"=>$a2, "enfants"=>[$enfant[2]]]);
$e[] = new TestEmployes(["nom"=> "Wallace","prenom"=> "Marcelus","dateEmbauche"=> new DateTime("2000-10-29"),"poste"=> "Agent de sécurité","salaire"=> 23,"service"=> "Sécurité", "agence"=>$a3, "enfants"=>[$enfant[4]]]);
$e[] = new TestEmployes(["nom"=> "Doe","prenom"=> "John","dateEmbauche"=> new DateTime("1980-12-06"),"poste"=> "Responsable","salaire"=> 50,"service"=> "RH", "agence"=>$a3, "enfants"=>[$enfant[3]]]);
