...
{
    public partial class testrelationsentityContext : DbContext
    {
        public testrelationsentityContext()
        {
        }

        public testrelationsentityContext(DbContextOptions<testrelationsentityContext> options)
            : base(options)
        {
        }
