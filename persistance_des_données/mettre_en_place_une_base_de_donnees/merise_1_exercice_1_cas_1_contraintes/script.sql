...
ALTER TABLE Artistes ADD dateCreation DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE Artistes ADD dateModification DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE Labels ADD dateCreation DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE Labels ADD dateModification DATETIME DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE Disques ADD dateCreation DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE Disques ADD dateModification DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP;